...
const FileMenu = ({anchorE1, chatId}) => {
  ...
  const fileChangeHandler = async(e, key) => {
    ...
    if(files.length > 5) return toast.error(`You can sen only 5${key} at a time`);
    ...
    <Menu anchorEl={anchorE1} open={isFileMenu} onClose={closeFileMenu} >
      <div style={{width:"10rem"}}>
        <MenuList>
          ...
          <input type="file" multiple accept="audio/mp3, audio/wav, audio/mpeg" style={{display:"none"}} onChange={(e) => fileChangeHandler(e, "Audios")} ref={audioRef} />
          </MenuItem>
          ...
          <input type="file" multiple accept="video/mp4, video/mkv, video/webm, video/ogg" style={{display:"none"}} onChange={(e) => fileChangeHandler(e, "Videos")} ref={videoRef} />
          </MenuItem>
