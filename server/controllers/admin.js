...
const cookieOption = { maxAge: 900000, sameSite: 'none', httpOnly: true, secure: true };
...
const adminLogin = TryCatch(async (req, res, next) => {
  ...
  return res.status(200).cookie("chat_app_token_admin",token,{cookieOption}).json({
      success: true,
